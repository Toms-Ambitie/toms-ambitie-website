        ...
        <section style={{ background: 'var(--wit-warm)', padding: '0 0 160px' }}>
          <div className="container-wide">
            ...
            <LegalSection num={1} title="Wie wij zijn">
              ...
              <P>Onder Toms Ambitie kunnen handelsnamen en ventures vallen zoals Plug and Power, EmmaStudio, PostPilot, OAK Marketing en toekomstige platformen. Zolang een venture geen eigen rechtspersoon of KvK inschrijving heeft, valt deze juridisch onder Toms Ambitie.</P>
