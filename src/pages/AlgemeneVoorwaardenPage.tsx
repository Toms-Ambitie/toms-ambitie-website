        ...
        <section style={{ background: 'var(--wit-warm)', padding: '0 0 160px' }}>
          <div className="container-wide">
            ...
            <LegalSection num={12} title="AI toepassingen">
              ...
              <P>Gebruikers blijven altijd zelf verantwoordelijk voor controle, interpretatie, publicatie en beslissingen. Dit is extra belangrijk bij platformen zoals EmmaBoekt en PostPilot.</P>
            </LegalSection>
